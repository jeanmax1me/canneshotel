...
function page() {
  return (
    <div className={alegreya.className}>
      ...
      >
        <h2
        className="mb-1 text-xl">From 2 until 5 October</h2>
        <h3 className="mb-2 text-3xl">TFWA World Exhibition & Conference</h3>
      ...
      <motion.div
       ...
       transition={{delay: 0.2, x:{type:"spring", stiffness:60}, opacity:{duration:1}, ease:"easeIn", duration: 1,}}
      >
        <h2 className="mb-1 text-xl mt-4">From 16 until 19 October</h2>
        <h3 className="mb-2 text-3xl ">MIPCOM</h3>
      ...
      <motion.div
       ...
       transition={{delay: 0.2, x:{type:"spring", stiffness:60}, opacity:{duration:1}, ease:"easeIn", duration: 1,}}
      >
        <h2 className="mb-1 text-xl mt-4">From 8 until 9 November</h2>
        <h3 className="mb-2 text-3xl ">E-Retail and E-Commerce Meetings</h3>
...
00
      ...
      >
        <h2 className="mb-1 text-xl mt-4">From 8 until 9 November</h2>
        <h3 className="mb-2 text-3xl ">Transports and Logistics Meetings</h3>
      ...
      <motion.div
       ...
       transition={{delay: 0.2, x:{type:"spring", stiffness:60}, opacity:{duration:1}, ease:"easeIn", duration: 1,}}
      >
        <h2 className="mb-1 text-xl mt-4">From 7 until 9 November</h2>
        <h3 className="mb-2 text-3xl ">Mare di Moda</h3>
